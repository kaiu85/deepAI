...
# Load learned Agent
with open('evAI_mountaincar_backprop_best.pkl', 'r') as f:
...
oats_given = theano.shared(name = 's_t0', value = numpy.concatenate( (-0.5*numpy.ones( (10, n_oa,n_samples) ), 0.0*numpy.ones( (n_sample_steps - 10, n_oa,n_samples) )), axis = 0).astype( dtype = theano.config.floatX ), borrow = True )
